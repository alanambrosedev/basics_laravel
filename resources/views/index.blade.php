                ...
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        @can('create', \App\Models\Post::class)
                            <a class="btn-sm btn-success btn mx-1" href="{{ route('posts.create') }}">Create</a>
                            <a class="btn-sm btn-warning btn mx-1" href="{{ route('posts.trashed') }}">Trashed</a>
                        @endcan
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        @can('update', $post)
                                            <a class="btn-sm btn-primary btn"
