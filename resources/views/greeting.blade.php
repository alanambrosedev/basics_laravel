...
@section('content')
    <div class="">
        ...
        <p>{{ __('frontend.Localization in Laravel allows you to define translations for various language strings in your application. These translations can be used in your applications views, as well as within your applications PHP code.') }}
        </p>
        <div class="row">
            <ul class="row">
